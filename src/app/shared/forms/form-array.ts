...
/**
 * Extended version of the `FormArray` from `@angular/forms` with additional functionality.
 */
class OopFormArray<TControl extends AbstractControl> extends FormArray<TControl> {
...
export { OopFormArray as FormArray };
